 ...
 * @author hp
 */
public class VentanaAlimentos extends javax.swing.JPanel {   
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("insert into alimentos values(?,?,?,?,?)");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/inventario", "root", "");
            PreparedStatement pst = cn.prepareStatement("select * from alimentos where ID = ?");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (resp == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/inventario", "root", "");
                PreparedStatement pst = cn.prepareStatement("update alimentos set PRODUCTO = ?, CANTIDAD = ?, PRECIOxUNIDAD = ?, PRECIOTOTAL = ? where ID = " + id);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
            ...
            if (cantidadAAgregar > 0) {
                ...
                PreparedStatement pstCantidadActual = cn.prepareStatement("select CANTIDAD, PRECIOxUNIDAD from alimentos where ID = ?");
                ...
                if (rsCantidadActual.next()) {
                    ...
                    PreparedStatement pstActualizarCantidad = cn.prepareStatement("update alimentos set CANTIDAD = ?, PRECIOTOTAL = ? where ID = ?");
